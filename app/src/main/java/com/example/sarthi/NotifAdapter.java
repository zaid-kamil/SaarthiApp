...
public class NotifAdapter extends RecyclerView.Adapter<NotifAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull NotifAdapter.ViewHolder holder, int i) {
        ...
        if (tupe.equals("1")){
        holder.myText.setText(NotifInfo.getNamePass()+" wants to travel with you from "+NotifInfo.getInitLocat()+" at "+NotifInfo.getFinalLocat());
        ...
        if (tupe.equals("2")){
            holder.myText.setText(NotifInfo.getNameChauff()+" accepted your request to travel with him from "+NotifInfo.getInitLocat()+" at "+NotifInfo.getFinalLocat());
        ...
        if (tupe.equals("3")){
            holder.myText.setText(NotifInfo.getNameChauff()+" wants to be your carpooler of "+NotifInfo.getInitLocat()+" at"+NotifInfo.getFinalLocat());
            holder.accepter.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
        ...
        if (tupe.equals("4")){
            holder.myText.setText(NotifInfo.getNamePass()+" accepted your request for carpooling from "+NotifInfo.getInitLocat()+" at "+NotifInfo.getFinalLocat());
            holder.accepter.setVisibility(View.GONE);
            holder.refuser.setVisibility(View.GONE);
