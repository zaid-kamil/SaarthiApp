        ...
        chatBubble.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (idChauffeur.equals(myUid)) {
                    Toast.makeText(OfferDetails.this, "You cannot contact your profile", Toast.LENGTH_LONG);
                } else {
                ...
                mRefer.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (UserChauff.getPhone() != null) {
                            ...
                            Toast.makeText(OfferDetails.this, UserChauff.getName() + " doesn't have a phone number! ", Toast.LENGTH_LONG);
                        }
                    }
