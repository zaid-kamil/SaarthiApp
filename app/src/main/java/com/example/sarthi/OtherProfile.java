    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (Number<2){
                    NbrEval.setText(Number+" User");
                }else{
                    NbrEval.setText(Number+" Users");
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.report) {
            ...
            if (!user.getUid().equals(idChauffeur1)) {
                ...
                builder.setTitle("Why you want to report this user!");
                ...
                button1.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        MessageModel signalUser = new MessageModel(user.getUid(), "OSJvcLc0eJfpYLWjsJ2TU1ybubT2", "The Signaled is " + idChauffeur1 + "\n The Cause is" + cause);
